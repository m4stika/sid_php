...
* 
*/
class Kb_rekapitulasikasbank extends MY_Controller {
	...
	public function index() {
		...
		$pdf->reportHeader('Rekapitulasi Kas-Bank', 'C', 'B', sidlib::rgbColor(TITLE_COLOR), 18, 4, 'B','C');
		...
		//Generate PDF file
		ob_clean();
		$pdf->Output('Kb_rekapkasbank.pdf', 'I');
		ob_end_clean();
    }
}
?>