...
<script src="<?php echo base_url(); ?>assets/pages/scripts/journal_assign.js" type="text/javascript"></script>


<div class="margin-top-10" id= "row_assign">
    <div class="info"></div>
    <div class="portlet light">
        ...
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-helper"> Assign </span>
            </div>
            <div class="actions btn-set">
                <button type="button" class="btn btn-secondary-outline reset" ><i class="fa fa-refresh"></i>re-Load</button>
                <button type="button" class="btn btn-success save"><i class="fa fa-save"></i>Assign</button>
        ...
        <div class="portlet-body">
            <div class="m-heading-1 border-green m-bordered">
                <div class="row">  
                    <div class="form-group col-md-12">
                        <label class="col-md-2 col-sm-4 control-label" for="source">Source</label>
                    ...
                    <div class="form-group col-md-12 periode">
                        <!-- <input type="hidden" name="tglassign" id="tglassign" >
                        <input type="hidden" name="tglassignto" id="tglassignto" > -->
            ...
            <div class="table-container">
                <table class="table table-striped table-hover" id="table_assign">
                    <thead>
